...
namespace Voxelity.Extensions
{
    ...
    {
        public static Vector2 With(this Vector2 self, float? x = null, float? y = null) => new Vector2(x ?? self.x, y ?? self.y);
        ...
        public static Vector2Int With(this Vector2Int self, int? x = null, int? y = null) => new Vector2Int(x ?? self.x, y ?? self.y);
